...
import com.matera.pizzaria.exception.InvalidSignatureException;
import com.matera.pizzaria.exception.InvalidTokenException;
import com.matera.pizzaria.exception.TokenExpiredException;
...
public class JWTAuthenticationProvider implements AuthenticationProvider {
    ...
    public JWTAuthenticationProvider() {
        this.verifier = new MACVerifier(TokenUtils.sharedSecret);
    }
